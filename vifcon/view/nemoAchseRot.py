...
class NemoAchseRotWidget(QWidget):
    def __init__(self, sprache, Frame_Anzeige, widget, line_color, config, config_dat, neustart, add_Ablauf_function, nemoAchse, gamepad_aktiv, typ = 'Antrieb', parent=None):
        ...
        self.sta_Bit4_str       = ['Antrieb läuft im Uhrzeigersinn',                                                                            'Drive runs clock Wise']
        self.sta_Bit5_str       = ['Antrieb läuft gegen den Uhrzeigersinn',                                                                     'Drive runs counter clockwise']
        ...
        self.La_IstSpeed_text.setStyleSheet(f"color: {self.color[0]}")
        self.La_IstSpeed_wert.setStyleSheet(f"color: {self.color[0]}")
        #### Istwinkel:
        ...
        self.La_IstWin_text.setStyleSheet(f"color: {self.color[1]}")
        self.La_IstWin_wert.setStyleSheet(f"color: {self.color[1]}")
        #### Statuswert:
