...
class Multilog(QObject):
    def __init__(self, sprache, ports_send, ports_read, Ablauf_Funktion, widget_dict, device_dict, trigger_dict_sM, trigger_dict_rM):
        ...
        self.Log_Text_209_str   =   ['ACHTUNG: Bitte Multilog starten für den Aufbau der Kommunikation!! Aufbau Verbindung zu Port',    "ATTENTION: Please start Multilog to establish communication!! Establish connection to port"]
